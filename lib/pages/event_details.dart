...
import 'package:eventique/widget/accepted_serv_eve_det.dart';
import 'package:eventique/widget/my_pie_chart.dart';
import 'package:eventique/widget/my_row_texts.dart';
...
//dispose controller
  ...
  Widget build(BuildContext context) {
    ...
    final acceptedProvider =Provider.of<AcceptedServicesPro>(context, listen: true);
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: MyPieChart(totalPriceForOrder: acceptedProvider.getTotalPriceOfAcceptedServices(),services: acceptedProvider.services,),
            ),
              ...
              child: Row(
                children: [
                  ...
                  Padding(
                    ...
                    child: Text(acceptedProvider.services.length.toString(),style: TextStyle(color: primary),),
                  )
                ],
              ),
            ...
            AcceptedServices(acceptedList: acceptedProvider.services,),
          ],
        ),
      ),
    );
