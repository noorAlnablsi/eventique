...
//not used but i need it to review logic 
// class ForgetVerificationScreen extends StatefulWidget {
//   static const routeName = '/forget-verification';
...
//       print('forget verification code function');
//       print(verificationCode);
//       await Provider.of<Auth>(context, listen: false)
//           .forgetVerificationCode(verificationCode.trim());
//       Navigator.of(context).pushNamedAndRemoveUntil(
//           NewPasswordScreen.routeName, (route) => false);
//       setState(() {
//         _isLoading = false;
//       });
//       //show popup verified
//       _showDialog(context, 'content');
//     } catch (error) {
...
//                       ),
//                       TextSpan(
//                           text: 'taghreedswidah9@gmail.com',
//                           style: TextStyle(
//                               fontSize: 18,
//                               fontFamily: 'CENSCBK',
